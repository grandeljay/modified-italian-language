...
define('ENTRY_PASSWORD_ERROR', ' <span class="errorText">La sua password deve essere almeno ' . (definito('ENTRY_PASSWORD_MIN_LENGTH') ? ENTRY_PASSWORD_MIN_LENGTH : 0) . ' dei personaggi.</span>');
